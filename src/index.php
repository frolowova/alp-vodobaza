...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $postData = file_put_contents('data.json', $json);
    $formData = $_POST[''];
...
if ( $option == 'dataRegionAndBases' ) {
$mess = [ 'message' => 'Bases Water and Region List',
          'regions' => $regions,
          'basesWater' => $bw,
        ];
} elseif ($option == 'viewFile') {
    $file = file_get_contents('data.json');
    $mess = [ 'fileInfo' => $file ];
} else {
$mess = [ 'message' => 'Неизвестный запрос' ];
}
